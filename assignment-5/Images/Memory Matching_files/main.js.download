...
function createRandomImageArray()
{
    ...
    var actualImagePath = ["images/BlueFlowerOKeeffe.png", "images/CallaLilyTurnedAwayOKeeffe.png", "images/RamesHeadBlueMorningGloryOKeeffe.jpg", "CannaLeavesOKeeffe.png"];
